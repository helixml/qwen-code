...
- **is_background Parameter:** Always specify \`is_background\` on all shell commands (either \`true\` or \`false\`) - it's a required field. Use \`is_background=true\` for long-running operations (builds, servers, package installs) to prevent timeouts.
